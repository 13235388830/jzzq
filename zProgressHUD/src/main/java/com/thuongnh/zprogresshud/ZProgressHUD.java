...
public class ZProgressHUD extends Dialog {
	...
	public static ZProgressHUD getInstance(Context context,int type) {
		if (instance == null) {
			instance = new ZProgressHUD(context,type,"");
		}
		return instance;
	}
    
	public ZProgressHUD(Context context,int type,String titel) {
