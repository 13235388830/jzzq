...
public class GlideCatchUtil {
    ...
    public void clearImageAllCache() {
        ...
        String ImageExternalCatchDir = MyApplication.getContext().getExternalCacheDir() + ExternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR;
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(MyApplication.getContext().getCacheDir() + "/" + InternalCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
