...
import com.example.jzzq.main.My.activity.LoginYYActivity;
import com.example.jzzq.utils.CountDownTimerUtils;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.hqyzm:
                ...
                break;
            case R.id.tv_yydx:
                startActivity(new Intent(SplashThirdActivity.this, LoginYYActivity.class));
                break;
        }
    }
