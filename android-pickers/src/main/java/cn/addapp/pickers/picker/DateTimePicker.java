...
//        wheelViewParams.gravity = Gravity.CENTER;
        if(wheelModeEnable){
            ...
            if (dateMode == YEAR_MONTH_DAY || dateMode == YEAR_MONTH) {
                ...
                yearView.setDividerType(LineConfig.DividerType.MATCH);
            ...
            if (dateMode != NONE) {
                ...
                monthView.setCurrentItem(selectedMonthIndex);
                monthView.setDividerType(LineConfig.DividerType.MATCH);
...
//                        }
            ...
            if (dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) {
                ...
                dayView.setDividerType(LineConfig.DividerType.MATCH);
...
//                layout.setWeightSum(5);
                ...
                hourView.setDividerType(LineConfig.DividerType.MATCH);
                ...
                minuteView.setAdapter(new ArrayWheelAdapter<>(minutes));
                minuteView.setCurrentItem(selectedMinuteIndex);
                minuteView.setDividerType(LineConfig.DividerType.MATCH);
