...
//        wheelParams2.weight = 1;
        ...
        if(wheelModeEnable){
            ...
            firstView.setDividerType(LineConfig.DividerType.MATCH);
            ...
            secondView.setDividerType(LineConfig.DividerType.MATCH);
            ...
            if (!provider.isOnlyTwo()) {
                ...
                thirdView.setDividerType(LineConfig.DividerType.MATCH);
